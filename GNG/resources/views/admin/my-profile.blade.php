                ...
                <div class="card author-box">
                  <div class="card-body">
                    <div class="author-box-center">
                      <img alt="image" src="{{env('DEFAULT_IMAGE_URL').$data['profile_image']}}" class="author-box-picture author-box-profile">
                          ...
                          <div class="card-body">
                            ...
                            <div class="row">
                              <div class="form-group">
                                ...
                                <input type="hidden" class="form-control hdn_profile_image" name="hdn_profile_image" value="{{env('DEFAULT_IMAGE_URL').$data['profile_image']}}">
                              </div>
                            </div>
                          </div>
